...
const unsigned DMR_FRAME_LENGTH_BITS  = 264U;
const unsigned DMR_FRAME_LENGTH_BYTES = 33U;

const unsigned DMR_SYNC_LENGTH_BITS  = 48U;
const unsigned DMR_SYNC_LENGTH_BYTES = 6U;

const unsigned DMR_EMB_LENGTH_BITS  = 8U;
const unsigned DMR_EMB_LENGTH_BYTES = 1U;

const unsigned DMR_SLOT_TYPE_LENGTH_BITS  = 8U;
const unsigned DMR_SLOT_TYPE_LENGTH_BYTES = 1U;

const unsigned DMR_EMBEDDED_SIGNALLING_LENGTH_BITS  = 32U;
const unsigned DMR_EMBEDDED_SIGNALLING_LENGTH_BYTES = 4U;

const unsigned DMR_AMBE_LENGTH_BITS  = 108U * 2U;
const unsigned DMR_AMBE_LENGTH_BYTES = 27U;
...
const unsigned DMR_SLOT_TIME = 60U;
const unsigned AMBE_PER_SLOT = 3U;
