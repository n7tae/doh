...
public:
	...
	virtual void setRFParams(unsigned int rxFrequency, int rxOffset, unsigned int txFrequency, int txOffset, int txDCOffset, int rxDCOffset, float rfLevel);
	virtual void setModeParams(bool dmrEnabled);
	virtual void setLevels(float rxLevel, float cwIdTXLevel, float dmrTXLevel);
